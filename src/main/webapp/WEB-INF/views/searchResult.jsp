...
<body>
   <div class="container">
      ...
      <hr>
      <div class="row">
      <div class="row-xs" style="height:50px; padding-left:30px;" >
         
      	<b>${term}</b>에 대한 <font color="blue">${totalCnt }개</font>의 검색 결과입니다.  	<br>
      </div>
   	<div class="row-xs" style="width:100%;text-align:center; padding:10px;">
         <div class="col-sm">
