...
<div class="container-fluid" style="width:510px;background-color: #eee;">
      ...
      <form name="findpwdcheck" action="findpwdcheck" method="post">

         <div class="row">

            <div class="col">

               <input type="text" class="form-control" id="id" name="id" placeholder="아이디" style="font-size:21px; margin-bottom: 10px;">
